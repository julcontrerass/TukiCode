...
const EMAILJS_SERVICE_ID = 'service_j65ltii';
const EMAILJS_TEMPLATE_ID = 'template_j1sxoa3';
const EMAILJS_PUBLIC_KEY = 'BzMoWWhuLs2W61pPb';
...
export default function ContactSection({ t }: ContactSectionProps) {
  ...
  return (
    ...
    <section id="contacto" className="h-screen max-h-screen pt-20 md:pt-8 pb-24 md:pb-8 bg-black flex flex-col items-center justify-center relative overflow-hidden">
      <FogReveal className="max-w-5xl mx-auto px-4 z-10 w-full h-full flex flex-col justify-center max-h-full overflow-y-auto">
        {/* Header */}
        ...
        <div className="grid md:grid-cols-5 gap-4 md:gap-6 items-start">
          ...
          <div className="md:col-span-2 grid grid-cols-3 md:grid-cols-1 gap-2 md:gap-3 order-2 md:order-1">
            ...
            <div className="relative space-y-3 md:space-y-4">
              ...
              <div className="flex gap-3">
                <m.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center justify-center gap-2 px-4 py-3 md:py-3.5 rounded-2xl bg-[#25D366]/15 text-[#25D366] hover:bg-[#25D366]/25 transition-all border-2 border-[#25D366]/40 font-bold text-sm md:text-base flex-1 group/wa relative overflow-hidden shadow-lg hover:shadow-[0_0_30px_rgba(37,211,102,0.3)]"
                >
                ...
                <m.a
                  href="https://www.instagram.com/tuki_code/"
                  target="_blank"
                  rel="noopener noreferrer"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center justify-center gap-2 px-4 py-3 md:py-3.5 rounded-2xl bg-pink-500/10 text-pink-400 hover:bg-pink-500/20 transition-all border-2 border-pink-500/30 font-bold text-sm md:text-base flex-1 group/ig relative overflow-hidden shadow-lg hover:shadow-[0_0_30px_rgba(236,72,153,0.3)]"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 to-pink-500/10 translate-y-full group-hover/ig:translate-y-0 transition-transform"></div>
                  <svg className="w-5 h-5 relative z-10 group-hover/ig:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor">
