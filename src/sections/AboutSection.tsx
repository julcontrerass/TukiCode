  ...
  return (
    <section id="nosotros" className="min-h-screen py-24 bg-black relative z-10 flex flex-col justify-center">
      <div className="max-w-7xl mx-auto px-4 w-full">
        <FogReveal className="text-center mb-16 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          <FogReveal delay={100}>
            <div className="bg-zinc-900/30 border border-zinc-800 p-8 rounded-3xl backdrop-blur-sm hover:border-blue-500/50 transition-colors relative overflow-hidden group">
          ...
          <FogReveal delay={200}>
            <div className="bg-zinc-900/30 border border-zinc-800 p-8 rounded-3xl backdrop-blur-sm hover:border-purple-500/50 transition-colors relative overflow-hidden group">
        ...
        <FogReveal delay={150} className="text-center">
