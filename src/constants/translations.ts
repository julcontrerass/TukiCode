...
export const translations: Translations = {
  es: {
    ...
    contact: {
      ...
      subjectLabel: "Asunto",
      subjectPlaceholder: "Desarrollo de aplicación web",
      ideaLabel: "Cuéntanos tu idea",
      messagePlaceholder: "Cuéntanos sobre tu proyecto, presupuesto estimado, plazos...",
  ...
  en: {
    ...
    contact: {
      ...
      subjectPlaceholder: "Web application development",
      ideaLabel: "Tell us your idea",
      messagePlaceholder: "Tell us about your project, estimated budget, deadlines...",
      btn: "Request Quote",
